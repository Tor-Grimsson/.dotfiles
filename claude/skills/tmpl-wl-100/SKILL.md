---
name: tmpl-wl-100
description: Word-limit the reply to 100% of the normal ceiling — a hard body budget of ~250 words. Overflow FOLDS INTO THE FOOTER, never trails after it. Stays standing until another tmpl-wl-* is set. Triggered by /tmpl-wl-100 (user-invoked only).
---

# tmpl-wl-100 — 100% output budget

**Body budget: ~250 words.** the normal ceiling — no expansion, this is not permission to grow
