...
Pure orientation — answers *where is it, what's the shape*, not *run this command*. For commands: [[kol-bucket-b2]] (Backblaze) / [[kol-bucket-r2]] (Cloudflare). Canon + live tree snapshots: `~/.dotfiles/docs/operations/systems/cdn/`.
...
- `~/.dotfiles/docs/operations/systems/cdn/02-b2-tree.md` / `04-r2-tree.md` — readable tree per provider (Obsidian)
- `~/.dotfiles/docs/operations/systems/cdn/_files/<bucket>/{tree.json, tree.full.txt}` — raw (scripts/nvim)
...
- `~/.dotfiles/docs/operations/systems/cdn/INDEX.md` — full canon: bucket-tree mechanics, drift detection, distribution to Obsidian/consumers
