---
name: tmpl-wl-80
description: Word-limit the reply to 80% of the normal ceiling — a hard body budget of ~200 words. Overflow FOLDS INTO THE FOOTER, never trails after it. Stays standing until another tmpl-wl-* is set. Triggered by /tmpl-wl-80 (user-invoked only).
---

# tmpl-wl-80 — 80% output budget

**Body budget: ~200 words.** trim: drop the second supporting block
