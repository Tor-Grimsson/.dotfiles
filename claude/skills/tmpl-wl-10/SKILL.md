---
name: tmpl-wl-10
description: Word-limit the reply to 10% of the normal ceiling — a hard body budget of ~25 words. Overflow FOLDS INTO THE FOOTER, never trails after it. Stays standing until another tmpl-wl-* is set. Triggered by /tmpl-wl-10 (user-invoked only).
---

# tmpl-wl-10 — 10% output budget

**Body budget: ~25 words.** verdict line + footer. Everything else folds into the footer counts.
