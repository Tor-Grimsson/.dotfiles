---
title: ss-save path cheat sheet
type: reference
status: active
updated: 2026-07-08
description: ss-save.sh — save the clipboard image to a file via pngpaste; the two-arg (NAME then DIR) model, rules, and examples.
tags:
  - project/dotfiles
