...
| `bucket-` | [[14-bucket-drift|Drift]] · [[18-cdn-r2b2/INDEX|Tree snapshots]] | 2 | read-only CDN tooling — `bucket-drift.sh` (drift check) + `bucket-tree.sh` (tree snapshot → dotfiles → Obsidian) |
