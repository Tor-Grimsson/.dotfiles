...
## Future use
Front-end for the dedup pass: `dust` finds *where* the weight is, then the [[documentation/03-dedup-cleanup/INDEX|Dedup & Cleanup]] tools (rmlint/czkawka) remove the *duplicates* within it.
