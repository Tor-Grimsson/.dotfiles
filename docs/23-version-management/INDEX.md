...
related:
  - "[[../04-dev-languages/INDEX|Dev & Languages]]"
...
The manager is **global** (install once per machine — belongs in the Brewfile + shell rc). The pin file is **per-repo** (lives in the project, travels with it). See [[../21-dotfiles/INDEX|the dotfiles model]] for that global-vs-per-repo split applied across the whole setup.
