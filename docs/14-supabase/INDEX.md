...
> **First thing you'll need:** the Supabase CLI — `brew install supabase/tap/supabase` (or run it ad-hoc with `npx supabase@latest …`). Full setup in [[03-setup-walkthrough|chapter 03]].
