...
related:
  ...
  - "[[01-iterm2|iTerm2]]"
  - "[[09-productivity-desktop/04-stats|Stats]]"
---
...
It's the live counterpart to [[07-fastfetch|fastfetch]] (which prints a one-shot specs banner) and the terminal counterpart to [[09-productivity-desktop/04-stats|Stats]] (the always-on menu-bar gauge).
