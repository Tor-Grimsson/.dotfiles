...
## Why installed
The markdown renderer for [[../02-file-management/02-yazi|yazi]]'s `.md` preview pane, and a nicer full-screen reader than glow for docs with headings or images. The dotfiles are markdown-heavy; mdcat is the cleanest in-terminal view of them.
...
- See [[../02-file-management/02-yazi|yazi]] for the full preview-backend picture.
