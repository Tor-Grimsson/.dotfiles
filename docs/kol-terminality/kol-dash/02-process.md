...
| Phase | What | Status |
|---|---|---|
| 1 | `os-mode.sh` — toggle/set/relative-timer theme control, Raycast-hotkeyed | **Built** — [[18-appearance\|18-appearance]] |
| 2 | `theme-alarm.sh` — real clock-time bundle: theme + Focus + Spotify + Telegram, `launchd`-scheduled | **Built** — [[18-appearance\|18-appearance]] |
