...
related:
  ...
  - "[[systems/claude-harness/02-skills|skills]]"
---
...
| 4 | **KOL-accessible** | Its keybinds are registered in a **`ref` card**, its folders in **`files`** — the print-to-shell surfaces. Greppable from the shell, not doc-only. |
