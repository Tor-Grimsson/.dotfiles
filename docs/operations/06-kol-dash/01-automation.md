...
related:
  - "[[INDEX|kol-dash]]"
  - "[[02-process|Process]]"
  - "[[18-appearance|Appearance & wake automation (full flag reference)]]"
---

# Automation

Per-flag detail lives at [[18-appearance|12-scripts/18-appearance]] — this doc is the *why this shape* for the two triggers involved.
