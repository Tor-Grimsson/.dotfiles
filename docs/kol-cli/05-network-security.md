...
related:
  ...
  - "[[operations/04-remote-machine/INDEX|Remote machine]]"
---
...
*Living doc — the practical layer over `docs/documentation/05-network-security`. Per-tool depth in the linked docs. Symlinked into the kol-vault for print.*
