-- Comment.nvim + ts-context-commentstring: builtin gc can't switch comment
-- style inside jsx/tsx blocks — this stack can.
return {
  {
    "JoosepAlviste/nvim-ts-context-commentstring",
    lazy = true,
    opts = {
      enable_autocmd = false, -- Comment.nvim triggers it
    },
  },
  {
